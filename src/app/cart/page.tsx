...
export default function CartPage() {
        ...
        return (
            <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <h1 className="font-display text-2xl font-normal text-earth">
                        Your cart is empty
                    </h1>
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <h1 className="font-display text-3xl font-normal uppercase tracking-tight text-earth mb-10">
                Shopping Cart
            </h1>
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
                ...
                <div>
                    <div className="rounded-2xl border border-sand/50 bg-linen p-6">
                        <h2 className="font-display text-lg font-normal text-earth">
                            Order Summary
                        </h2>
